...
#Ouputter
    ...
    do_parallel_test: bool = field(default=False, metadata={"help": "not use"})
    ...
    use_dynamic_rl_weight: bool=field(default=False)
    ...
    add_rl_loss: bool=field(default=False, metadata={"help": "use adding for loss combination"})
