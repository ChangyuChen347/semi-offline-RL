# This file contains code adapted from the BRIO repository on GitHub.
# Repository URL: https://github.com/yixinL7/BRIO
# Original file: cal_rouge.py
...
_ROUGE_PATH = os.environ.get('_ROUGE_PATH')
