...
class SQUAD_BLEU():
    def __init__(self, model_name, cfg, **kwargs):
        ...
        if self.cfg.eval_dir == 'static_data/squad/squad_valid.tsv':
            self.src = open('lmqg/sentence-valid.txt').readlines()
            self.tgt = open('lmqg/question-valid.txt').readlines()
        elif self.cfg.eval_dir == 'static_data/squad/squad_test.tsv':
            self.src = open('lmqg/sentence-test.txt').readlines()
            self.tgt = open('lmqg/question-test.txt').readlines()
